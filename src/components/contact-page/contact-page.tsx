                ...
                <div className="container mx-auto px-4">
                    <div className="text-center">
                        ...
                        <p className="text-xl md:text-2xl text-black max-w-4xl mx-auto">
                            Furnishing – Vinyl & PVC Flooring Experts in Malaysia
                        </p>
                    </div>
                </div>
            </div>
                ...
                <div className="container mx-auto px-4">
                    <div className="text-center mb-12">
                        <h2 className="text-3xl font-bold text-gray-900 mb-4">
                            Why Reach Out to <span className="text-orange-600">Furnishing</span>?
                        </h2>
                ...
                <div className="container mx-auto px-4">
                    <div className="max-w-4xl mx-auto text-center">
                        <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-8">
                            Business <span className="text-orange-600">Hours</span>
                        </h2>
                                    ...
                                    <div className="space-y-6">
                                        ...
                                        <div>
                                            ...
                                            <textarea
                                                ...
                                                onChange={handleInputChange}
                                                rows={6}
                                                className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-600 focus:border-orange-600 transition-colors resize-vertical"
                                        ...
                                        <button
                                            ...
                                            className="w-full bg-orange-600 hover:bg-orange-700 text-white font-semibold py-4 px-6 rounded-lg transition-colors duration-200 text-lg"
                                        >
                                            SEND MESSAGE
                                        </button>
                                    </div>
            ...
            <div className="py-16">
                <div className="container mx-auto px-4">
                    <div className="max-w-6xl mx-auto">
                        <div className="text-center mb-12">
                            <h2 className="text-3xl  font-bold text-gray-900 mb-4">
                                Get Directions to <span className="text-orange-600">Our Showroom</span>
                            </h2>
                            ...
                            <div className="h-96 bg-gray-200 relative">
                                ...
                                <div className="absolute inset-0 pointer-events-none">
                                    <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
                                        <div className="w-6 h-6 bg-orange-600 rounded-full border-4 border-white shadow-lg animate-pulse"></div>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div className="py-16 bg-white">
                <div className="container mx-auto px-4">
                    <div className="max-w-4xl mx-auto">
                        <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-8">
                            Why Clients Choose <span className="text-orange-600">Furnishing</span>
                        </h2>
